...
# --------------------------------------------------------------
def count_reps(dataset, cutoff=0.4, order=10, column="acc_r",plotting=True):
...
for s in df["set"].unique():
    ...
    reps=count_reps(subset,cutoff=cutoff,column=column,plotting=False)
